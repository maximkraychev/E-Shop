...
export class CatalogComponent {
  mockData = [
    {title: 'Game Of Thrones', author: 'George R. R. Martin', price: '30', discountPrice: '20', img: '/assets/book1.jpg'},
    {title: 'Harry Potter And The Order of the Phoenix', author: 'J.K.Rowling', price: '30', discountPrice: '20', img: '/assets/book2.jpg'},
